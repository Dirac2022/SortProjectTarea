...
import uni.aed.model.BasePersonas;
...
public class FrmDirectorio extends javax.swing.JFrame {
    ...
    public FrmDirectorio() {
        initComponents();
        lstInitial.setModel(modeloList1);
        lstFinal.setModel(modeloList2);
    ...
    private void initComponents() {
        ...
        btnGroupSearchAlgorithm = new javax.swing.ButtonGroup();
        ...
        pnlSearchAlgorithm.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Search Algoritmo:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 8))); // NOI18N

        btnGroupSearchAlgorithm.add(rbSearchLineal);
        rbSearchLineal.setSelected(true);
        rbSearchLineal.setText("Lineal");

        btnGroupSearchAlgorithm.add(rbSearchBinaria);
        rbSearchBinaria.setText("Binaria");

        javax.swing.GroupLayout pnlSearchAlgorithmLayout = new javax.swing.GroupLayout(pnlSearchAlgorithm);
        pnlSearchAlgorithm.setLayout(pnlSearchAlgorithmLayout);
        pnlSearchAlgorithmLayout.setHorizontalGroup(
            pnlSearchAlgorithmLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlSearchAlgorithmLayout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(rbSearchLineal, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(48, 48, 48)
                .addComponent(rbSearchBinaria, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(132, 132, 132))
        );
        pnlSearchAlgorithmLayout.setVerticalGroup(
            pnlSearchAlgorithmLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlSearchAlgorithmLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(pnlSearchAlgorithmLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        btnGeneraPersonas.setText("Genera Personas");
        btnGeneraPersonas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGeneraPersonasActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(29, 29, 29)
                .addComponent(btnGeneraPersonas)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(34, 34, 34)
                .addComponent(btnGeneraPersonas, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(6, 6, 6)
                                        .addComponent(pnlSearchAlgorithm, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jpDataEntry, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(pnlSearchAlgorithm, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jpListaInicial, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        String persona = nombre + "||" + edad + "||" + genero;
        
        SearchAlgorithms search = new SearchAlgorithms();
        Object [] listaObjetos = modeloList1.toArray();
        String [] listaPersonas = new String [listaObjetos.length];
        for(int i = 0; i < listaPersonas.length; i++) {
            listaPersonas[i] = listaObjetos[i].toString();
        }
        
        int index;
            
        if(rbSearchLineal.isSelected()){
            index = search.linearSearch(listaPersonas, persona);
            System.out.println("Se esta usando la busqueda lineal");
        }
            ...
            JOptionPane.showMessageDialog(btnBuscar, "Primero harémos un ligero ordenamiento de los elementos", 
                    "BÚSQUEDA", JOptionPane.INFORMATION_MESSAGE);
            Sort.mergeSort(listaPersonas, comp);
            modeloList1.removeAllElements();
            for(String p : listaPersonas)
                modeloList1.addElement(p);
            
            index = search.binarySearch(listaPersonas, persona);
            System.out.println("Se esta usando la busqueda binaria");
        }
            
               
        if(index != -1)
            personFounded(index, true);
        else
            personFounded(index, false);
    }//GEN-LAST:event_btnBuscarActionPerformed

    private void btnGeneraPersonasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneraPersonasActionPerformed
        BasePersonas base = new BasePersonas();
        Persona [] listaPersonas = base.generaPersonas(10);
        modeloList1.removeAllElements();
    ...
    }//GEN-LAST:event_btnGeneraPersonasActionPerformed
    
    
    private void personFounded(int index, boolean found){
        if (found)
            JOptionPane.showMessageDialog(btnBuscar, "La persona ha sido encontrada en la posición " + (index + 1), 
                    "BÚSQUEDA", JOptionPane.INFORMATION_MESSAGE);
        else
            JOptionPane.showMessageDialog(btnBuscar, "La persona no ha sido encontrada con los datos ingresados ",
                    "BÚSQUEDA", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private javax.swing.JButton btnGeneraPersonas;
    private javax.swing.ButtonGroup btnGroupSearchAlgorithm;
    ...
    private javax.swing.JPanel pnlSearchAlgorithm;
